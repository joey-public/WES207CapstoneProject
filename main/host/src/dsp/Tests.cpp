...
bool test_calc_mag()
{
    ...
    std::vector<float> gout_0 = { 
        ...
        std::abs(tvec_0[9]) };
    std::vector<float> tout_0 = proc::calc_mag(tvec_0);
    if(tout_0 != gout_0){std::cout<< "failed\n";return false;}
    else{std::cout << "pass!\n";}

    //test 1
    std::cout << "\ttest 1...";
    std::vector<RX_DTYPE> tvec_1 = {
    ...
    std::vector<float> gout_1 = { 
        ...
        std::abs(tvec_1[9]) };
    std::vector<float> tout_1 = proc::calc_mag(tvec_1);
    if(tout_1 != gout_1){std::cout<< "failed\n";return false;}
    else{std::cout << "pass!\n";}

    //test 2
    std::cout << "\ttest 2...";
    std::vector<RX_DTYPE> tvec_2 = {
    ...
    std::vector<float> gout_2 = { 
        ...
        std::abs(tvec_2[9]) };
    std::vector<float> tout_2 = proc::calc_mag(tvec_2);
    if(tout_2 != gout_2){std::cout<< "failed\n"; return false;}
    else{std::cout << "pass!\n";}

    //test 3
    std::cout << "\ttest 3...";
    std::vector<RX_DTYPE> tvec_3 = {
    ...
    std::vector<float> gout_3 = { 
        ...
        std::abs(tvec_3[9]) };
    std::vector<float> tout_3 = proc::calc_mag(tvec_3);
    if(tout_3 != gout_3){std::cout<< "failed\n"; return false;}
    else{std::cout << "pass!\n";}

    //test 4
    std::cout << "\ttest 4...";
    std::vector<RX_DTYPE> tvec_4 = {
    ...
    std::vector<float> gout_4 = { 
        ...
        std::abs(tvec_4[9]) };
    std::vector<float> tout_4 = proc::calc_mag(tvec_4);
...
bool test_calc_phase()
{
    ...
    std::vector<float> gout_0 = { 
        ...
        std::arg(tvec_0[9]) };
    std::vector<float> tout_0 = proc::calc_phase(tvec_0);
    if(tout_0 != gout_0){std::cout<< "failed\n";return false;}
    else{std::cout << "pass!\n";}
    ...
    std::vector<float> gout_1 = { 
        ...
        std::arg(tvec_1[9]) };
    std::vector<float> tout_1 = proc::calc_phase(tvec_1);
    if(tout_1 != gout_1){std::cout<< "failed\n";return false;}
    else{std::cout << "pass!\n";}
    ...
    std::vector<float> gout_2 = { 
        ...
        std::arg(tvec_2[9]) };
    std::vector<float> tout_2 = proc::calc_phase(tvec_2);
    if(tout_2 != gout_2){std::cout<< "failed\n"; return false;}
    else{std::cout << "pass!\n";}
    ...
    std::vector<float> gout_3 = { 
        ...
        std::arg(tvec_3[9]) };
    std::vector<float> tout_3 = proc::calc_phase(tvec_3);
    if(tout_3 != gout_3){std::cout<< "failed\n"; return false;}
    else{std::cout << "pass!\n";}
    ...
    std::vector<float> gout_4 = { 
        ...
        std::arg(tvec_4[9]) };
    std::vector<float> tout_4 = proc::calc_phase(tvec_4);
    if(tout_4 != gout_4){std::cout<< "failed\n"; return false;}
    else{std::cout << "pass!\n";}
