...
%%
% read data from file
%datafile = fopen('0525/raw_data_vinit.bin'); % filename of USRP capture File
%datafile2 = fopen('0525/raw_data_joey_20230525.bin'); % filename of USRP capture File
...
samples_to_plot = startidx2+1:startidx2+12000;
data_to_filter = data(samples_to_plot);

samples_to_plot_rec2 = startidx2_rec2+1:startidx2_rec2+12000;
data_to_filter2 = data2(samples_to_plot_rec2);
